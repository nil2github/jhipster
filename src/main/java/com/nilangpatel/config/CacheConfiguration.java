...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.nilangpatel.domain.School.class.getName(), jcacheConfiguration);
            cm.createCache(com.nilangpatel.domain.School.class.getName() + ".teachers", jcacheConfiguration);
            cm.createCache(com.nilangpatel.domain.Teacher.class.getName(), jcacheConfiguration);
